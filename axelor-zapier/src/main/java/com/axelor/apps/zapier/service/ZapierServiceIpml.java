...
public class ZapierServiceIpml implements ZapierService {
  ...
  public void mapFields(Map<String, Object> data) throws ClassNotFoundException {
  ...
  public Object getFieldRelation(Property property, Object value) {
  ...
  protected Object getFieldType(Property property, Object value) {
  ...
  @Transactional(rollbackOn = {Exception.class})
  protected Object addM2OBinding(Property property, Object value) {
  ...
  protected Object addM2MBinding(Property property, Object value) {
  ...
  protected Object addO2OBinding(Property property, Object value) {
    Class subKlass = property.getTarget();
    Map<String, Object> map = Mapper.toMap(Mapper.toBean(subKlass, new HashMap<>()));
    Mapper mapper = Mapper.of(subKlass);
    Object bean = null;
  ...
  protected LocalDate bindLocalDate(String value, Property property) {
    if (value != null) {
  ...
  @Override
  public List<Map> getMetaFieldList(Class<Model> klass) {
  ...
  @Transactional(rollbackOn = {Exception.class})
  @Override
  public Object updateRecord(Map<String, Object> data) throws ClassNotFoundException {
  ...
  private Model getRecord(Map<String, Object> data, Class<Model> klass)
    ...
    Model model = null;
    try {
      model = repo.all().filter(filter).fetchOne();
      return model;
    } catch (Exception e) {
    }
    return model;
